...
DiasMesesAnos q2(char datainicial[], char datafinal[])
{
    ...
    while(datainicial[i] != '\0' && datainicial[i] != '\n'){
        if(datainicial[i] == '/'){
            ...
            if(barra == 0) d1 = d1*10 + v;
            else if(barra == 1) m1 = m1*10 + v;
            else a1 = a1*10 + v;
        }
        i++;
    }
    ...
    while(datafinal[i] != '\0' && datafinal[i] != '\n'){
        if(datafinal[i] == '/'){
            ...
            int v = datafinal[i] - '0';
            if(barra == 0) d2 = d2*10 + v;
            else if(barra == 1) m2 = m2*10 + v;
            else a2 = a2*10 + v;
        }
        i++;
    }
...
int q7(char matriz[8][10], char palavra[5])
{
    ...
    for(linha = 0; linha < 8; linha++){
        for(coluna = 0; coluna < 10; coluna++){
            ...
            if(matriz[linha][coluna] != palavra[0]) continue;

            //  DIREITA →
            for(k = 0; palavra[k] != '\0'; k++){
                if(coluna + k >= 10) break;
                if(matriz[linha][coluna + k] != palavra[k]) break;
            }
            if(palavra[k] == '\0') return 1;
            ...
            for(k = 0; palavra[k] != '\0'; k++){
                if(linha + k >= 8) break;
                if(matriz[linha + k][coluna] != palavra[k]) break;
            }
            if(palavra[k] == '\0') return 1;
            ...
            //  DIAGONAL ↘
            for(k = 0; palavra[k] != '\0'; k++){
                if(linha + k >= 8 || coluna + k >= 10) break;
                if(matriz[linha + k][coluna + k] != palavra[k]) break;
            }
            if(palavra[k] == '\0') return 1;

            //  DIAGONAL ↙
            for(k = 0; palavra[k] != '\0'; k++){
                if(linha + k >= 8 || coluna - k < 0) break;
                if(matriz[linha + k][coluna - k] != palavra[k]) break;
            }
            if(palavra[k] == '\0') return 1;
            ...
            //  DIAGONAL ↗
            for(k = 0; palavra[k] != '\0'; k++){
                if(linha - k < 0 || coluna + k >= 10) break;
                if(matriz[linha - k][coluna + k] != palavra[k]) break;
            }
            if(palavra[k] == '\0') return 1;
